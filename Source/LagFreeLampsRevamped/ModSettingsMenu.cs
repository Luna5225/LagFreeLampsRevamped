...
namespace LagFreeLampsRevamped
{
    ...
    public class PatchDisablerMod : Mod
    {
        ...
        {
        new PatchDescription("campfire.xml", "Campfires"),
        new PatchDescription("cooler.xml", "Passive Coolers"),
        new PatchDescription("chemfuelPoweredGenerator.xml", "Chemfuel-Powered Generators"),
        new PatchDescription("woodFiredGenerator.xml", "Wood-Fired Generators"),
        new PatchDescription("brazier.xml", "Braziers", "Requires Royalty DLC"),
        new PatchDescription("darktorch.xml", "Dark Torches", "Requires Ideology DLC"),
        new PatchDescription("darktorchfungus.xml", "Fungal Dark Torches", "Requires Ideology DLC"),
        new PatchDescription("vg_campfire", "Bamboo Campfires", "Requires VGP Vegetable Garden"),
        new PatchDescription("vg_torchLamp", "Bamboo Torches", "Requires VGP Vegetable Garden")
        };
    ...
    public class DisablePatch_Settings : ModSettings
    {
        ...
        public void DoWindowContents(Rect canvas)
        {
            ...
            options.Label("");
            options.Label("What Should Be Exempt to Fueling?");
