...
namespace LagFreeLampRevamped
{
    ...
    {
        new PatchDescription("PatchOnePointThree.xml", "Torches", "Torches Do NOT Use Fuel?"),
        new PatchDescription("braziers.xml", "Braziers", "Braziers Do NOT Use Fuel?"),
        new PatchDescription("darktorch.xml", "Dark Torches", "Dark Torches Do NOT Use Fuel?"),
        new PatchDescription("darktorchfungus.xml", "Dark Torches (Fungal)", "Fungal Dark Torches Do NOT Use Fuel?"),
        new PatchDescription("cooler.xml", "Passive Coolers", "Passive Coolers Do NOT Use Fuel?"),
        new PatchDescription("campfire.xml", "Campfires", "Campfires Do NOT Use Fuel?"),
        new PatchDescription("woodFiredGenerator.xml", "Wood Fired Generators", "Wood Fired Generators Do NOT Use Fuel?"),
        new PatchDescription("chemfuelPoweredGenerator.xml", "Chemfuel Powered Generators", "Wood Fired Generators Do NOT Use Fuel?")
        };
